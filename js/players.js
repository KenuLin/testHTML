...
// 變得太重，屆時可以考慮拆成多個檔案或改用簡易的靜態搜尋索引。補上
// crawl-club-squads.ts（各球會完整陣容，不只世界盃球員）之後目前約 1
// 萬多筆球員、未壓縮 5MB 多／gzip 後約 600KB，GitHub Pages 預設會 gzip，
// 實測載入+解析在合理範圍內，還不用拆檔，但已經比原本「1000 多筆」重不少，
// 之後資料再明顯變多時要回頭注意這裡。
